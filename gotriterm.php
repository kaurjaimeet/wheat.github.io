...
$sql="SELECT * FROM blastc273 WHERE GO_names LIKE '%$name%'";
...
$counter = 1;
    ...
    while($row = $result->fetch_assoc()) {
               ...
               echo "<tr bgcolor='#ffe6ff'><td>Number of Go terms</td><td>".$row['GO']."</td></tr>";
                echo "<tr bgcolor='#ffcccc'><td>Go Id</td><td>".$row['GO_Id']."</td></tr>";
                echo "<tr bgcolor='2eb0e5'><td>Description</td><td>".$row['GO_names']."</td></tr>";
