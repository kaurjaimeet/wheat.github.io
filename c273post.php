...
#$sql="SELECT * FROM c273heat WHERE Sequence_Id='$name'";
...
$sql="SELECT * FROM c273heat,c273heatsequence,mercatorc273 WHERE c273heat.Sequence_Id=c273heatsequence.Sequence_Id AND c273heat.Sequence_Id=mercatorc273.Sequence_Id AND c273heat.Sequence_Id  ='$name'";
